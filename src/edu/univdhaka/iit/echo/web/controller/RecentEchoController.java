...
@WebServlet("/recentEchos")
public class RecentEchoController extends HttpServlet {

	private static final long serialVersionUID = 7429250758571675333L;

	private static final Logger log = LoggerFactory
			.getLogger(RecentEchoController.class);
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		RequestDispatcher requestDispatcher = req
				.getRequestDispatcher("/WEB-INF/jsp/recentEchos.jsp");
