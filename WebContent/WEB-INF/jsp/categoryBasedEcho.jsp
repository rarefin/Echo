	...
	$(document).ready(function()
  	{
		...
		$("#cb").css("color","#306").fadeOut(2000).fadeIn(2000);
		i=i-1;
		}
	});
...
<body>
    ...
    %>
		...
		<table id="main" align="center" style="width: 550px;">
			<tr>
				<td style="font-size: x-large;" align="center"><br>
				<label id="cb">Category Based Echos</label><br> <br></td>
			</tr>
		</table>

		<c:if test="${fn:length(categoryBasedEchos) > 0 }">
			<div class="span6 well text-error">
				<c:forEach items="${categoryBasedEchos}" var="entry">
