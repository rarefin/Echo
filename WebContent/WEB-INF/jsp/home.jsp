	...
	$(document).ready(function()
  	{
		...
		$("#re").css("color","#306").fadeOut(2000).fadeIn(2000);
		i=i-1;
		}
	});
    ...
    %> <% response.setIntHeader("Refresh", 25);%>
		...
		<table id="main" align="center" style="width: 550px;">
			<tr>
				...
				<label id="re">Recent Echos</label><br> <br></td>
			</tr>
		</table>

		<c:if test="${fn:length(recentEchos) > 0 }">
			<div class="span6 well text-error">
				<c:forEach items="${recentEchos}" var="entry">
